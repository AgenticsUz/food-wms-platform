...
/// </summary>
/// <remarks>
/// F6: foydalanuvchi limiti faqat KO'RSATILADI, bloklamaydi — odamni zavodga Console biriktiradi
/// (D7) va WMS'ning uni «limit to'ldi» deb rad etishi tushunarsiz bo'lardi (<c>PlanLimits</c> izohi).
/// </remarks>
...
/// </summary>
/// <remarks>
/// F6: <c>Branding</c> O'CHDI — brendlash endi <c>/api/me</c> bilan keladi (D14), ikki manba
/// bo'lsa biri eskirib qolardi. Modullar Identity obunasidan (D6).
/// </remarks>
