...
/// <remarks>
/// F6: kalit Guid (Identity tenant id), <c>Slug</c> o'rniga Identity'dagi <c>Code</c> (login
/// endi Identity'da, slug bo'yicha kirish yo'q). Modullar Identity obunasidan (D6).
/// Brendlash ham shu yerda — <c>/api/me</c> uni har so'rovda bazaga bormasdan beradi (D14).
/// </remarks>
